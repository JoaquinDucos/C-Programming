...
{
int n;
float articulos, Sum, Faltante, MontoBonif, Desc;
...
for (n=1; n<=5; n++)
   ...
   printf("\nEl valor total de los articulos es de: $%7.2f.\n\nIngrese el monto a partir del cual se realizara una bonificacion!: \n $", Sum);
   scanf("%f", &MontoBonif);
   printf("\nIngrese ahora el monto a bonificar: \n$");
   scanf("%f", &Desc);
          ...
          if(Sum>MontoBonif)
            {
                 ...
                 printf("\nLa compra ha superado los $%7.2f, obtienes un descuento de $%7.2f!\n", MontoBonif, Desc);
                 printf("\nEl precio total a pagar es de: $%7.2f \n\n", Sum);
            }
          ...
          else if(Sum<MontoBonif)
              {
                 ...
                 printf("\nTe faltan $%7.2f para poder obtener un descuento de $%7.2f!\n\n", Faltante, Desc);
              }
       }
       else
           {
