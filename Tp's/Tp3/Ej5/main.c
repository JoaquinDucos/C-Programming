...
float x, y;
  ...
  printf("\n-------------------------------------\n");
       ...
       if( x>0 && y<0)
   {
       ...
       if( x==0 && y>0)
   {
        printf("\nEl punto dado se encuentra sobre el eje Y positivo, entre el primer y segundo cuadrante!\n\n");
   }
       if( x==0 && y<0)
   {
        printf("\nEl punto dado se encuentra sobre el eje Y negativo, entre el tercer y cuarto cuadrante!\n\n");
   }
   
       if( x>0 && y==0)
   {
        printf("\nEl punto dado se encuentra sobre el eje X positivo entre el primer y cuarto cuadrante!\n\n");
   }
       if( x<0 && y==0)
   {
        printf("\nEl punto dado se encuentra sobre el eje X negativo entre el segundo y tercer cuadrante!\n\n");
   }
   
       if( x==0 && y==0)
   {
        printf("\nEl punto dado se encuentra en el origen de coordenadas!\n\n");
   }
